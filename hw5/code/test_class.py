...
makeConfMat(classifier, train_data_map, train_labels, CLASS_TRAIN_CONF,
        title=train_conf_title)
test_conf_title = 'Test Confusion Matrix'
makeConfMat(classifier, test_data_map, test_labels, CLASS_TEST_CONF,
        title=test_conf_title)
test_err = classifier.eval(test_data_map, test_labels)
