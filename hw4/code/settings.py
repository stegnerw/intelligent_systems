...
CLASS_CLEAN_POINTS_PER_EPOCH = 3000
CLASS_CLEAN_VALID_POINTS = 1000
CLASS_CLEAN_MAX_EPOCHS = 500
CLASS_CLEAN_ETA = 0.005
CLASS_CLEAN_ALPHA = 0.8
CLASS_CLEAN_DECAY = 0.0
CLASS_CLEAN_L = 0.25
CLASS_CLEAN_H = 0.75
CLASS_CLEAN_PATIENCE = 5
CLASS_CLEAN_ES_DELTA = 0.0
# Clean autoencoder constants
AUTO_CLEAN_POINTS_PER_EPOCH = 3000
AUTO_CLEAN_VALID_POINTS = 1000
AUTO_CLEAN_MAX_EPOCHS = 500
AUTO_CLEAN_ETA = 0.01
AUTO_CLEAN_ALPHA = 0.8
AUTO_CLEAN_DECAY = 0.0001
AUTO_CLEAN_L = 0
AUTO_CLEAN_H = 1
AUTO_CLEAN_PATIENCE = 5
AUTO_CLEAN_ES_DELTA = 0.005
# Noise parameters
SALT_PROB = 0.05
PEP_PROB = 0.4
# Noisy classifier constants
CLASS_NOISY_POINTS_PER_EPOCH = 3000
CLASS_NOISY_VALID_POINTS = 1000
CLASS_NOISY_MAX_EPOCHS = 500
CLASS_NOISY_ETA = 0.005
CLASS_NOISY_ALPHA = 0.8
CLASS_NOISY_DECAY = 0.0
CLASS_NOISY_L = 0.25
CLASS_NOISY_H = 0.75
CLASS_NOISY_PATIENCE = 5
CLASS_NOISY_ES_DELTA = 0.0
# Noisy autoencoder constants
AUTO_NOISY_POINTS_PER_EPOCH = 3000
AUTO_NOISY_VALID_POINTS = 1000
AUTO_NOISY_MAX_EPOCHS = 500
AUTO_NOISY_ETA = 0.005
AUTO_NOISY_ALPHA = 0.8
AUTO_NOISY_DECAY = 0.00025
AUTO_NOISY_L = 0
AUTO_NOISY_H = 1
AUTO_NOISY_PATIENCE = 5
AUTO_NOISY_ES_DELTA = 0.005
...
CLASS_NOISY_LOSS_PLOT = CLASS_NOISY_IMG_DIR.joinpath('loss_graph.png')
CLASS_NOISY_TRAIN_CONF = CLASS_NOISY_IMG_DIR.joinpath('train_conf_mat.png')
CLASS_NOISY_TEST_CONF = CLASS_NOISY_IMG_DIR.joinpath('test_conf_mat.png')
CLASS_NOISY_DATA_DIR = DATA_DIR.joinpath(CLASS_NOISY_NAME)
CLASS_NOISY_DATA_DIR.mkdir(mode=0o775, exist_ok=True)
CLASS_NOISY_TEST_LOSS = CLASS_NOISY_DATA_DIR.joinpath('test_loss.dat')
CLASS_NOISY_PARAM_CSV = CLASS_NOISY_DATA_DIR.joinpath('parameters.csv')
CLASS_NOISY_BEST_EPOCH = CLASS_NOISY_DATA_DIR.joinpath('best_epoch.dat')
